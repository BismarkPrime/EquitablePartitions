...
TODO:
    ...
    Parallelization
    Use some sort of bucket sort in splitcolor to achieve lower complexity
"""
...
class ColorClass(LinkedList):
    ...
    """
    __slots__ = 'out_edge_neighbors', \
        'curr_color_neighbors', 'split_color', 'curr_conns'
